            ...
            {filteredPosts.length === 0 ? (
              ...
              filteredPosts.map((post) => (
                <div
                  ...
                  className="bg-[#14171d] border border-[#21242c] hover:border-slate-700 rounded-2xl p-6 shadow-xl transition-all cursor-pointer group space-y-4 relative"
                >
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {safeBandwidthOffers.map((offer) => (
              <div
                key={offer.id}
                className="bg-[#14171d] border border-[#21242c] hover:border-emerald-500/40 rounded-2xl p-5 shadow-xl space-y-3 transition-all"
              >
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-2.5">
